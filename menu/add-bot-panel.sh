...
data_ip="https://raw.githubusercontent.com/Jembudmerah/Regist/main/Ipvps"
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "      \033[0;36mTelegram${NC} t.me/SabdoStore"
    echo -e "      ${GREEN}WhatsApp${NC} wa.me/6285161256106"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    sleep 5
    reboot
  fi
...
echo -e   ""
case $opt in
01 | 1) clear ; wget https://raw.githubusercontent.com/Jembudmerah/Purel/main/kyt.sh && chmod +x kyt.sh && ./kyt.sh ;;
